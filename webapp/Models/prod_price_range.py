...
class Prod_price_range(Base):
    __tablename__= 'prod_price_range'
    #__table_args__ = {'schema':'admin'}
    prod_price_range_id = Column(Integer, primary_key = True)
    prod_id = Column(Integer, ForeignKey('prod_info.prod_id'))
    prod_info=relationship(Prod_info,backref='price_ranges')
    ...
    def __repr__(self):
        return '<prod_price_range prod_price_range_id:%d,prod_id:%s>' % (self.prod_price_range_id,self.prod_id)
